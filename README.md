...
- 🎯 **AI Product Manager at GTM Buddy** — Owns and ships AI and Agentic capabilities across GTM Buddy; **Customer Champion from Product** who closed ~60 customer asks across 23+ enterprises in 10 weeks
- 🚀 **Led and launched** an agentic AI platform, a visual workflow-automation builder, and an AI-integration layer (100+ tools) at GTM Buddy
- 🏢 **Founder of [InfinitiGrid](https://infinitigrid.com/) (2023 →)** — AI services and solutions provider serving 15+ B2B clients across femtech, edtech, legaltech, and SaaS
- 💬 **Built [Your Law Chat](https://infinitigrid.com/) in 2023** — AI legal-consultation chatbot; **first company in India to launch an LLM chatbot on WhatsApp**; 1,200+ users in 3 months, 82% repeat usage, NPS 75
- ✍️ **PMM → PM transition** — closed **₹3.7 Cr (~$440K) in 4 months** as PMM at a B2B SaaS; launched a recruitment platform that processed 230K+ applications and filled 42K+ jobs
- 🎓 **MBA from Masters' Union** — AI Lead, Third Block Community; awarded **"Most Creative Problem Solver"** from 10,000+ applicants

## 🧪 What's in my profile

- 📝 **formatmd-new** — Markdown formatting utility
...
<p align="center">
  🌱 Currently exploring: <em>Agentic Harnesses · MCP · Scheduled AI infra · Local LLMs · Agentic Engineering at Scale</em>
</p>
